                ...
                <div class='row'>
                    <div class='form-group'>
                        <div class='col-sm-6 col-md-6'>
                            ...
                            <input class='form-control FormInput' type='text' autocomplete='off' name='Judul' id='Judul' placeholder='Judul' />
                        </div>
                        <div class='col-sm-6 col-md-6'>
                            <label class='control-label'>Gambar</label>
                            <input class='form-control FormInput' accept='.jpg,.jpeg,.png' type='file' autocomplete='off' name='Gambar' id='Gambar' />
                        </div>
                    </div>
