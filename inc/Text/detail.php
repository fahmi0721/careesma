                ...
                <div class='row'>
                    <div class='form-group'>
                        <div class='col-sm-6 col-md-6'>
                            ...
                            <input class='form-control FormInput' autocomplete='off' name='Judul' id='Judul' placeholder='Judul' />
                        </div>
                    </div>

                    <div class='form-group'>
                        <div class='col-sm-12 col-md-12' for="IsiText">
                            <label class='control-label'>Isi Text</label>
                            <textarea id='IsiText' name='IsiText' autocomplete=off rows='10'  class='form-control FormInput' placeholder='Isi Text'></textarea> 
                        </div>
                    </div>
                    <div class='form-group'>
                        <div class='col-sm-6 col-md-6'>
