...
<div class="row">
    <div class="col-md-3">
        ...
        <div class="box-body box-profile">
            ...
            <a href='index.php?page=Applicant' class='btn btn-block btn-sm btn-danger' type='submit'><i class='fa fa-mail-reply'></i> Kembali</a>
        </div>
        <!-- /.box-body -->
        </div>
        <!-- /.box -->
    ...
    <div class="col-md-9">
        ...
        <ul class="nav nav-tabs">
            ...
            <li <?php if(isset($_GET['aksi']) && $_GET['aksi'] == "Sertifikasi"){ echo "class='active'"; } ?>><a href="#Sertifikasi" data-toggle="tab">Sertifikasi</a></li>
