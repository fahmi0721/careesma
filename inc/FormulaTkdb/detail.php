    ...
    <div class="box-body">
        ...
        <form  id='FormData' class='form-horizontal'>
            ...
            <div class='col-md-4 col-sm-3'>
                <small>Catatan:
                        <ul>
                            <li>sebelum menambah formula soal pastikan soal telah diselesai di acak</li>
                            <li>pilih lowongan pekerjaan</li>
                        </ul>
                    </small>
            </div>
                ...
                <div class='row'>
                    <div class='form-group'>
                        <div class='col-sm-6 col-md-6'>
                            ...
                            <select class='form-control select-job-vacancy'  name='IdJobVacancy' id='IdJobVacancy' placeholder='Lowongan Pekerjaan'></select>
                        </div>
                    </div>
