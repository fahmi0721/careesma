...
// 	Clear();
// 	LoadData();
// 	$("#TglLahir").datepicker({ dateFormat : "yy-mm-dd", autoclose : true })
...
// 	$.ajax({
// 		type: "POST",
// 		url: "inc/Group/proses.php?proses=DetailData",
...
// 				type: "POST",
// 				dataType: "json",
// 				url: "inc/Group/proses.php?proses=ShowData",
// 				data: "Id=" + Id,
...
// 	var aksi = $("#aksi").val();
// 	var iForm = ["Nama"];
// 	var KetiForm = ["Nama Group belum lengkap!"];
// 	for (var i = 0; i < iForm.length; i++) {
// 		if (aksi != "delete") {
// 			if ($("#" + iForm[i]).val() == "") { Customerror("Group", "001", KetiForm[i], 'proses'); $("#" + iForm[i]).focus(); scrolltop(); return false; }
// 		}
// 	}
...
// 		$.ajax({
// 			type: "POST",
// 			url: "inc/Group/proses.php?proses=Crud",
// 			data: data,
// 			beforeSend: function () {
// 				StartLoad();
// 			},
...
// 					Clear();
// 					Customsukses("Group", '001', res['pesan'], 'proses');
// 					LoadData();
// 					StopLoad();
// 				} else {
// 					Customerror("Group", "001", res['pesan'], 'proses');
// 					StopLoad();
// 				}
// 			},
// 			error: function (er) {
